...
SECRET_KEY = 'django-insecure-r@xn-3c327qj1+qbz5g(jz$g!%i1d_@05+xj67y#ghh%g%t*d)'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': '',  # Your PostgreSQL username if needed
...
# Add this line to define the static files root directory
